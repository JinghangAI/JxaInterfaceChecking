...
# @Author    : CuiHanBin
# @File      : test_099_getTextChoisePageInfosetName.py
...
class JhApp(unittest.TestCase):
    ...
    def test_getTextChoisePageInfoSetName_correct(self):
        try:
            ...
            line = int(get_sheet.cell(81, 0).value)
            ...
            if result.status_code == 200:
                ...
                if 'data' in result_dict:
                    data_value = result_dict['data']['texts'][0]
