# -*- coding : utf-8 -*-
# @Time      : 2020.03.11 14:30
# @Author    : CuiHanBin
# @File      : test_112_collectedListPageInfo.py
...
class JhApp(unittest.TestCase):
    ...
    def test_collectedListPageInfo_correct(self):
        try:
            ...
            line = int(post_sheet.cell(35, 0).value)
            ...
            if result.status_code == 200:
                ...
                if 'data' in result_dict:
                    data_value = result_dict['data']['textInfo']
