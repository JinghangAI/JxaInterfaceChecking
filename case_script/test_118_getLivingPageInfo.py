# -*- coding : utf-8 -*-
# @Time      : 2020.03.21 14:00
# @Author    : CuiHanBin
# @File      : test_118_getLivingPageInfo.py
...
class JhApp(unittest.TestCase):
    ...
    def test_getLivingPageInfo_correct(self):
        try:
            ...
            line = int(get_sheet.cell(88, 0).value)
            ...
            if result.status_code == 200:
                ...
                if 'data' in result_dict:
                    data_value = result_dict['data']['course']
