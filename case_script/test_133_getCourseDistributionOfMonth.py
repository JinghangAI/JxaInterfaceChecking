# -*- coding : utf-8 -*-
# @Time      : 2020.04.23 16:00
# @Author    : CuiHanBin
# @File      : test_133_getCourseDistributionOfMonth.py
...
class JhApp(unittest.TestCase):
    ...
    def test_getCourseDistributionOfMonth_correct(self):
        try:
            ...
            line = int(get_sheet.cell(100, 0).value)
