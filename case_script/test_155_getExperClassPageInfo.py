...
# @Time     : 2020/7/4 17:17
# @Author   : CuiHanBin
# @File     : test_155_getExperClassPageInfo.py
...
class JhApp(unittest.TestCase):
    ...
    def test_getExperClassPageInfo_correct(self):
        try:
            ...
            line = int(post_sheet.cell(45, 0).value)
            ...
            if result.status_code == 200:
                ...
                if 'data' in result_dict:
                    data_value = result_dict['data']['experClassTopicInfo']
