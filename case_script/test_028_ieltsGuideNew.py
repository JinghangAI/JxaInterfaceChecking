# -*- coding : utf-8 -*-
# @Time      : 2020.02.12 10:30
# @Author    : CuiHanBin
# @File      : test_028_ieltsGuideNew.py
...
class JhApp(unittest.TestCase):
    ...
    def test_ieltsGuideNew_correct(self):
        try:
            ...
            if result.status_code == 200:
                result_text = result.text.encode("raw_unicode_escape").decode("utf-8")
                print(result_text)
            else:
