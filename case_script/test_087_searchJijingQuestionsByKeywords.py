# -*- coding : utf-8 -*-
# @Time      : 2020.03.03 11:30
# @Author    : CuiHanBin
# @File      : test_087_searchJijingQuestionsByKeywords.py
...
class JhApp(unittest.TestCase):
    ...
    def test_searchJijingQuestionsByKeywords_correct(self):
        try:
            ...
            line = int(post_sheet.cell(11, 0).value)
