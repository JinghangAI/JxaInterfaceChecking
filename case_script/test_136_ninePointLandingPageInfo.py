# -*- coding : utf-8 -*-
# @Time      : 2020.05.13 16:30
# @Author    : CuiHanBin
# @File      : test_136_ninePointLandingPageInfo.py
...
class JhApp(unittest.TestCase):
    ...
    def test_ninePointLandingPageInfo_correct(self):
        try:
            ...
            line = int(get_sheet.cell(102, 0).value)
            ...
            if result.status_code == 200:
                ...
                if 'code' in result_dict:
                    ...
                    if str(code_value) != '200':
                        send_msg(send_err)
                else:
                    send_msg(send_err)
                if 'data' in result_dict:
                    data_value = result_dict['data']['acInfo']
