#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time     : 2020/5/22 18:42
# @Author   : CuiHanBin
# @File     : test_139_ninePointZeroPay.py
...
class JhApp(unittest.TestCase):
    ...
    def test_ninePointZeroPay_correct(self):
        try:
            ...
            line = int(post_sheet.cell(41, 0).value)
            ...
            if result.status_code == 200:
                ...
                if 'code' in result_dict:
                    ...
                    if str(code_value) != '405':    # 没有九分达人优惠券
                        print(result_text)
                        send_msg(send_err)
                else:
                    send_msg(send_err)
