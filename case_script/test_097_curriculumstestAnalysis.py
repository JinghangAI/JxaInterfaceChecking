# -*- coding : utf-8 -*-
# @Time      : 2020.03.05 15:00
# @Author    : CuiHanBin
# @File      : test_097_curriculumstestAnalysis.py
...
class JhApp(unittest.TestCase):
    ...
    def test_curriculumsTestAnalysis_correct(self):
        try:
            ...
            line = int(post_sheet.cell(23, 0).value)
            ...
            if result.status_code == 200:
                ...
                if 'data' in result_dict:
                    data_value = result_dict['data']['user']
