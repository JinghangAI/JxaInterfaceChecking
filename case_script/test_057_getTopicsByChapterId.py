# -*- coding : utf-8 -*-
# @Time      : 2020.02.25 16:00
# @Author    : CuiHanBin
# @File      : test_057_getTopicsByChapterId.py
...
class JhApp(unittest.TestCase):
    ...
    def test_getTopicsByChapterId_correct(self):
        try:
            ...
            line = int(get_sheet.cell(56, 0).value)
            ...
            if result.status_code == 200:
                ...
                if 'data' in result_dict:
                    data_value = result_dict['data']['topicInfo'][0]
