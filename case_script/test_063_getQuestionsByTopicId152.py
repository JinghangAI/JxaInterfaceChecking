# -*- coding : utf-8 -*-
# @Time      : 2020.02.26 14:40
# @Author    : CuiHanBin
# @File      : test_063_getQuestionsByTopicId152.py
...
class JhApp(unittest.TestCase):
    ...
    def test_getQuestionsByTopicId_correct(self):
        try:
            ...
            line = int(get_sheet.cell(62, 0).value)
            ...
            if result.status_code == 200:
                ...
                if 'data' in result_dict:
                    data_value = result_dict['data']['questionInfo'][0]
