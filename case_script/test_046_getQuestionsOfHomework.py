# -*- coding : utf-8 -*-
# @Time      : 2020.02.22 15:30
# @Author    : CuiHanBin
# @File      : test_046_getQuestionsOfHomework.py
...
class JhApp(unittest.TestCase):
    ...
    def test_getQuestionsOfHomework_correct(self):
        try:
            ...
            line = int(get_sheet.cell(45, 0).value)
            ...
            if result.status_code == 200:
                ...
                if 'data' in result_dict:
                    data_value = result_dict['data']['returnInfo'][0]
