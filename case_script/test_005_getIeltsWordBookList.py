# -*- coding : utf-8 -*-
# @Time      : 2020.01.15 16:00
# @Author    : CuiHanBin
# @File      : test_005_getIeltsWordBookList.py
...
class JhApp(unittest.TestCase):
    ...
    def test_getIeltsWordList_correct(self):
        try:
            ...
            line = int(get_sheet.cell(4, 0).value)
            ...
            if result.status_code == 200:
                ...
                if 'data' in result_dict:
                    data_value = result_dict['data']['bookList'][0]
