# -*- coding : utf-8 -*-
# @Time      : 2020.03.07 11:00
# @Author    : CuiHanBin
# @File      : test_098_getTypeChoisePageInfo.py
...
class JhApp(unittest.TestCase):
    ...
    def test_getTypeChoisePageInfo_correct(self):
        try:
            ...
            line = int(get_sheet.cell(80, 0).value)
            ...
            if result.status_code == 200:
                ...
                if 'data' in result_dict:
                    data_value = result_dict['data']['typeList'][0]
