# -*- coding : utf-8 -*-
# @Time      : 2020.01.20 11:30
# @Author    : CuiHanBin
# @File      : test_009_getIeltsMainPageInfo.py
...
class JhApp(unittest.TestCase):
    ...
    def test_getIeltsMainPageInfo_correct(self):
        try:
            ...
            line = int(get_sheet.cell(8, 0).value)
            ...
            if result.status_code == 200:
                ...
                if 'data' in result_dict:
                    data_value = result_dict['data']['banner']
