# -*- coding : utf-8 -*-
# @Time      : 2020.02.28 10:30
# @Author    : CuiHanBin
# @File      : test_074_campClassesList2.py
...
class JhApp(unittest.TestCase):
    ...
    def test_campClassesList_correct(self):
        try:
            ...
            line = int(get_sheet.cell(73, 0).value)
            ...
            if result.status_code == 200:
                ...
                if 'code' in result_dict:
                    ...
                    if code_value != 401:   # {"code":401,"msg":"用户未购买该课程"}
                        send_msg(send_err)
                else:
                    send_msg(send_err)
            else:
