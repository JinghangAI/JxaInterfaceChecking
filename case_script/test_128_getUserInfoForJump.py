# -*- coding : utf-8 -*-
# @Time      : 2020.04.07 16:00
# @Author    : CuiHanBin
# @File      : test_128_getUserInfoForJump.py
...
class JhApp(unittest.TestCase):
    ...
    def test_getUserInfoForJump_correct(self):
        try:
            ...
            line = int(get_sheet.cell(97, 0).value)
