# -*- coding : utf-8 -*-
# @Time      : 2020.01.15 18:00
# @Author    : CuiHanBin
# @File      : test_007_curriculums_list.py
...
class JhApp(unittest.TestCase):
    ...
    def test_curriculumslist_correct(self):
        try:
            ...
            line = int(get_sheet.cell(6, 0).value)
            ...
            if result.status_code == 200:
                ...
                if 'data' in result_dict:
                    data_value = result_dict['data']['iTalkInfo']
