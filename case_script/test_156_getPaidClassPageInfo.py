...
# @Time     : 2020/7/6 10:42
# @Author   : CuiHanBin
# @File     : test_156_getPaidClassPageInfo.py
...
class JhApp(unittest.TestCase):
    ...
    def test_getPaidClassPageInfo_correct(self):
        try:
            ...
            line = int(post_sheet.cell(46, 0).value)
            ...
            if result.status_code == 200:
                ...
                if 'data' in result_dict:
                    data_value = result_dict['data']['paidClassTopicInfo']
