# -*- coding : utf-8 -*-
# @Time      : 2020.02.12 14:40
# @Author    : CuiHanBin
# @File      : test_031_startExam1.py
...
class JhApp(unittest.TestCase):
    ...
    @unittest.skip('this api not test!!!')
    def test_startExam_correct(self):
        try:
            ...
            line = int(get_sheet.cell(30, 0).value)
